...
class MQTTClient:
    ...
    def connect(self, clean_session=True, timeout=None):
        ...
        print("MQTT DEBUG: creating socket")
        self.sock = socket.socket()
        self.sock.settimeout(timeout)

        print("MQTT DEBUG: resolving", self.server, self.port)
        addr = socket.getaddrinfo(self.server, self.port)[0][-1]
        print("MQTT DEBUG: resolved to", addr)

        print("MQTT DEBUG: TCP connect")
        self.sock.connect(addr)
        print("MQTT DEBUG: TCP connected")
        ...
        print("MQTT DEBUG: sending CONNECT packet")
        ...
        print("MQTT DEBUG: CONNECT packet sent")
        print("MQTT DEBUG: waiting for CONNACK")

        resp = self.sock.read(4)

        print("MQTT DEBUG: CONNACK =", resp)
        ...
        print("MQTT DEBUG: MQTT connection successful")
